...
parser.add_argument('--model', default='indoor-L', type=str, help='model name')
...
parser.add_argument('--exp', default='weight', type=str, help='experiment setting')
...
#
# parser = argparse.ArgumentParser()
# parser.add_argument('--model', default='indoor-b', type=str, help='model name')
# parser.add_argument('--num_workers', default=1, type=int, help='number of workers')
# parser.add_argument('--data_dir', default='./data/', type=str, help='path to dataset')
